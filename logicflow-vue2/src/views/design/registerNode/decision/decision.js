...
export default function registerConnect(lf) {
  lf.register('decision', ({ HtmlNode, HtmlNodeModel }) => {
    ...
    class RuleModel extends HtmlNodeModel {
      ...
      initNodeData(data) {
        ...
        this.targetRules = [
          ...
          // {
          //   message: `【${nodeNameZh}】输入可连接开始、swing推荐、原生服务、连接器`,
          //   validate: (sourceNode, targetNode, _sourceAnchor, targetAnchor) => {
          //     if (['start', 'startParallel', 'machineLearning', 'deepLearning', 'restService'].includes(sourceNode.type)) {
          //       return true;
          //     } else {
          //       return false;
          //     }
        ...
        this.sourceRules = [
          ...
          // {
          //   message: `【${nodeNameZh}】输出可连接原生服务、连接器`,
          //   validate: (sourceNode, targetNode, _sourceAnchor, targetAnchor) => {
          //     if (['machineLearning', 'deepLearning', 'restService'].includes(targetNode.type)) {
          //       return true;
          //     } else {
          //       return false;
          //     }
