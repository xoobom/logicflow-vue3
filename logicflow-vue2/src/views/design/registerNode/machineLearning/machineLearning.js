    ...
    class RuleModel extends HtmlNodeModel {
      ...
      initNodeData(data) {
        ...
        this.targetRules = [
          ...
          //     if (['start', 'assignment', 'decision', 'startParallel', 'endParallel', 'machineLearning', 'deepLearning', 'restService'].includes(sourceNode.type)) {
          //       return true;
          //     } else {
          //       return false;
          //     }
        ...
        this.sourceRules = [
          ...
          //   validate: (sourceNode, targetNode, _sourceAnchor, targetAnchor) => {
          //     if (['assignment', 'decision', 'startParallel', 'endParallel', 'machineLearning', 'deepLearning', 'restService'].includes(targetNode.type)) {
          //       return true;
          //     } else {
          //       return false;
          //     }
